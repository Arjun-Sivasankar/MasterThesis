...
REL_CANON_SUBSTR = [
    ...
    (("patholog",), "pathology"),
    (("procedure_site", "direct_procedure_site", "indirect_procedure_site"), "proc_site"),
    (("method", "technique", "measurement_method", "finding_method"), "proc_method"),
    (("device", "instrument"), "proc_device"),
