...
if [ ${BASE_LLM} == "meta-llama/Llama-3.2-1B-Instruct" ]; then
    OUT_DIR=runs_textgen/llama3.2-1B/checkpoints
    ...
    OUT_DIR=runs_textgen/llama3.1-8B/checkpoints
    ADAPTER_DIR=runs_textgen/llama3.1-8B/adapter_v1
else
    OUT_DIR=runs_textgen/meditron3-8B/checkpoints
...
# OUT_DIR=runs_textgen/${BASE_LLM}/checkpoints
# ADAPTER_DIR=runs_textgen/${BASE_LLM}/adapter_v1
