...
echo "[INFO] Starting ICD-9 analysis for HA ..."

python analysis/icd9_analysis_HA.py \
    --train_pickle dataset/history_aware_data/train_df.pkl \
    --val_pickle dataset/history_aware_data/val_df.pkl \
    --test_pickle dataset/history_aware_data/test_df.pkl \
    --icd9_pickle dataset/codes/icd9.pkl \
    --output_dir analysis_results_HA \
